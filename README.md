...
=======================================
=======================================
<del>dorazmetka.parquet<br>
В unlabeled_train.parquet 784742 строк. Размер заказа доразметки 784742//100=7847 строк. В dorazmetka.parquet 7847 первых строк из dop460_3of3_18859.parquet. Можно считать заказ проверкой качеста доразметки выполненой участником. 
Проверку качества доразметки других участников выполнить не представляется возможным, поскольку необнаружены ни сама доразметка, ни доказательства её существования.</del><br>
ids_7847.csv - заказ доразметки организаторам.
