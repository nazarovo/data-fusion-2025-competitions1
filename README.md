...
Проверку качества доразметки других участников выполнить не представляется возможным, поскольку необнаружены ни сама доразметка, ни доказательства её существования.
